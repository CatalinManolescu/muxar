...
},{"./songsTestData":201,"react":199}],201:[function(require,module,exports){
module.exports = {
	songs: [
            {
                title: "Dreamin'",
...
var Header = React.createClass({displayName: "Header",
  ...
  searchTheItem:function(event){
	...
	render: function() {
		return (
        React.createElement("div", {className: "myHeader"}, 
          React.createElement("div", {className: "logoHolder"}, 
              React.createElement("img", {className: "logo", src: "images/logo.png"}), 
              React.createElement(SearchForm, {searchItem: this.state.searchItem, 
...
},{"../pages/searchForm":209,"react":199}],203:[function(require,module,exports){
"use strict";
...
var Menu = React.createClass({displayName: "Menu",
	render: function() {
		return (
	        React.createElement("div", {className: "myMenu"}, 
		        React.createElement("div", {className: "buttonsHolder"}, 
					React.createElement("div", {className: "menuComponent"}, React.createElement(Link, {to: "app"}, "genres")), 
		            React.createElement("div", {className: "menuComponent"}, React.createElement(Link, {to: "mood"}, "mood"))
	...
	render: function(){
		return (
			React.createElement("div", {className: "all"}, 
				...
				React.createElement("div", {className: "boxUnderHeader"}, 
					React.createElement(Menu, null)
				), 
				React.createElement("div", {className: "content"}, 
					React.createElement(RouteHandler, null)
				), 
				React.createElement(MyMusic, null)
			)
		);
...
},{"../common/header":202,"../common/menu":203,"./myMusic":207,"jquery":2,"react":199,"react-router":27}],205:[function(require,module,exports){
'use strict';

var React = require ("react");

var Genres = React.createClass({displayName: "Genres",
	getInitialState : function(){
		return{
			genres: []
		};
...
var MyMusic = React.createClass({displayName: "MyMusic",
	getInitialState: function() {
		return {
			songs: []
		};
	...
	render: function(){
		return (
        React.createElement("div", {className: "myMusic"}, 
			React.createElement("h1", null, "My Songs"), 
...
},{"../api/songsApi":200,"./songsList":210,"react":199}],208:[function(require,module,exports){
'use strict';

var React = require ('react');

var Recommendations = React.createClass({displayName: "Recommendations",
	render: function(){
		return (
	...
	render: function(){
		return(
			React.createElement("form", {className: "searchForm"}, 
	          React.createElement("input", {type: "text", value: this.props.searchItem.search, 
	                placeholder: " Search for a song..", className: "searchBox", 
	                onChange: this.props.onChange}), 
	          React.createElement("button", {type: "submit", className: "searchButton", onclick: this.props.onSave}, "Search")
	      	)
		);
	}
});
...
var SongsList = React.createClass({displayName: "SongsList",
	...
	render: function() {
		var createSongsRow = function(song) {
			return (
				React.createElement("tr", {key: song.id}, 
					React.createElement("td", null, song.title), 
					React.createElement("td", null, song.artist_name)
				)
			);
		};
...
},{"react":199}],211:[function(require,module,exports){
'use strict';
...
},{"./routes":212,"react":199,"react-router":27}],212:[function(require,module,exports){
'use strict';
...
var routes = (
	React.createElement(Route, {name: "app", path: "/", handler: require("./components/pages/app")}, 
		...
		React.createElement(Route, {name: "recommentations", handler: require("./components/pages/recommendations")})
	)
);

module.exports = routes;

},{"./components/pages/app":204,"./components/pages/genres":205,"./components/pages/mood":206,"./components/pages/recommendations":208,"react":199,"react-router":27}]},{},[211]);
